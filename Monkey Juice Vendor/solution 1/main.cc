...
int main() {
    ...
    vJuiceType order_list;

    // Creating Juice Vender: MagicJuiceMaker
    std::cout<<"**** Magic Juice Maker: \n";
    ...
    uint32_t call_counter = 7;
    while(call_counter-- >1) {

        customer1.GotoJuiceMaker(juice_maker); // Customer 1 choices a vendor and goes to it: Magic Juice Maker
        order_list = {JuiceType::Standard, JuiceType::Premium, JuiceType::Special};
